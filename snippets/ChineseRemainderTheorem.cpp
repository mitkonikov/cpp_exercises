// Chinese Remainder Theorem with generalization on non-coprime moduli
// Source: https://www.programmersought.com/article/34462894954/
...
int main() {
    ...
    vector<ll> offset(n), moduli(n);
    for (int i = 0; i < n; ++i) {
        cin >> offset[i] >> moduli[i];
    }

    cout << CRT(moduli, offset) << endl;
